  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/devops/svn/': [
        ...
        {
          text: 'Git', items: [
            { text: '开始', link: '/devops/svn/git/index' },
            { text: '使用', link: '/devops/svn/git/usage' },
            { text: '技巧', link: '/devops/svn/git/tips' },
            {
              text: 'Github',
              items: [
      ...
      '/mobile-development/kmp/': [
        ...
        { text: 'DI', link: '/mobile-development/kmp/di' },
        { text: 'Network', link: '/mobile-development/kmp/network' },
        ...
        { text: '运行', link: '/mobile-development/kmp/run' },
      ...
      '/os/linux/': [
        { text: '开篇', link: '/os/linux/' },
        {
          ...
          items: [
            ...
            { text: 'XDG', link: '/os/linux/note/xdg' },
          ]
        },
